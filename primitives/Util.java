...
/**
 * this class coming from Dan Zilberstein, in order to make the evaluate more accurate insteed of the "fixing"
 * numbers from the regular libraries
 */
public abstract class Util {
    ...
    // the number is m+2^_x where 1<=m<2
    // NB: exponent is stored "normalized" (i._x. always positive by adding 1023)
    ...
    /**
     * checks if the number is close enough to zero
     *
     * @return true if it close enough
     */
